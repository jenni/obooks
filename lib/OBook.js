...
class OBook {
    ...
    async create() {
        ...
        //@todo cover not available in meta page, get from titlePage
        const options = { title, author, publisher, cover: null, content: [] }
    ...
    getCoverImagePath(chapter) {
        const cover = chapter.images.filter(image => image === 'cover.jpg')
        return chapter.asset_base_url + cover
    }
